                ...
                <p>
                    <?php if(auth()->guest()): ?>
                        ...
                        <div class="form-group">
                            <a href="<?php echo e(url('/auth/github')); ?>" class="btn btn-github"><i class="fa fa-github"></i> Github</a>
                        <a href="<?php echo e(route('redirect_to_provider',['provider'=>'twitter'])); ?>" class="btn btn-twitter"><i class="fa fa-twitter"></i> Twitter</a>
                        <a href="<?php echo e(route('redirect_to_provider',['provider'=>'facebook'])); ?>" class="btn btn-facebook"><i class="fa fa-facebook"></i> Facebook</a>
                        </div>
                    <?php else: ?>
                    ...
                    <?php $__currentLoopData = $movies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $movie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-4">
                            <div class="card mb-4 box-shadow">
                                <img class="card-img-top" src="<?php echo e(asset($movie->image_url)); ?>"
                                     alt="<?php echo e($movie->image_url); ?>">


                                <?php if(auth()->guard()->check()): ?>
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-primary " style="float:left; width: 400px"
