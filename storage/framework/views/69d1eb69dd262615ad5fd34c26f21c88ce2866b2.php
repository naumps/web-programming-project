                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 box-shadow">
                            <div class="card-body">
                                ...
                                <form action="<?php echo e(route('post_basic_subscription')); ?>" method="POST">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 box-shadow">
                            <div class="card-body">
                                ...
                                <form action="<?php echo e(route('post_regular_subscription')); ?>" method="POST">
                                    <?php echo e(csrf_field()); ?>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 box-shadow">
                            <div class="card-body">
                                ...
                                <form action="<?php echo e(route('post_premium_subscription')); ?>" method="POST">
                                    <?php echo e(csrf_field()); ?>
